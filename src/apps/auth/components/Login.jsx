...
const Login = () => {
  ...
  const { login, signInWithGitHub , signInWithGoogle} = useContext(FirebaseContext)
        ...
        <form className=''>
          ...
          <div className='flex w-[90%] justify-center mx-auto text-white mt-4 text-xl gap-x-8'>
            <div
              ...
              className='bg-white text-black p-2 rounded-xl'>GitHub
            </div>

            <div
            onClick={signInWithGoogle}
            className='bg-white text-black p-2 rounded-xl'>Google
