...
const SidebarComponents = () => {
 ...
 return (
  <div className="flex flex-col h-screen w-1/6 bg-gray-800 text-white min-w-fit p-4 transition-all duration-300">
   ...
   <div className='flex justify-center items-center mt-8'>
    <ul className='flex flex-col gap-y-8'>
     ...
     <li className="flex justify-between items-center p-4 border-gray border-[1px]  hover:bg-gray-600 rounded-xl mt-8">
       ...
       <button className="text-white text-xl ">Dark Mode</button>
      </li>
    </ul>
   </div>
