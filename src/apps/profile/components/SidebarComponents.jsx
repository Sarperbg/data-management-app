...
const SidebarComponents = () => {
  ...
  return (
      <div className="flex flex-col  w-1/6 bg-gray-700 
     text-white min-w-fit p-4 transition-all duration-300 dark:bg-black dark:text-white">
        ...
        <div className='flex flex-col justify-center items-center py-2'>
          ...
          <h3 className='mt-6 text-xl text-center whitespace-nowrap'>Front End Developer</h3>
          <div className="flex flex-col justify-center items-center text-center text-sm w-[50%]">{t('Welcome')}: <h1>{user.email}</h1></div>
        </div>
